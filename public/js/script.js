...
var addPlan = document.querySelectorAll('.addPlan');
function updateCart(recipe) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/update-cart', recipe).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var recipe = JSON.parse(btn.dataset.recipe);
    updateCart(recipe);
    console.log(recipe);
  });
});
...
input.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    var _loop = function _loop(i) {
      ...
      rates.forEach(function (checkboxes) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkOmnifood_food_reccomendation_system"] = self["webpackChunkOmnifood_food_reccomendation_system"] || [];
